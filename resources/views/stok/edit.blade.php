                    ...
                    <div class="col-11">
                        <select class="form-control" id="barang_id" name="barang_id" required>
                            ...
                            @foreach($barang as $item)
                                <option value="{{ $item->barang_id }}" @if(old('barang_id', $stok->barang_id) == $item->barang_id) selected @endif>
                                    {{ $item->barang_nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-11">
                        <select class="form-control" id="user_id" name="user_id" required>
                            ...
                            @foreach($user as $item)
                                <option value="{{ $item->user_id }}" @if(old('user_id', $stok->user_id) == $item->user_id) selected @endif>
                                    {{ $item->nama }}
                                </option>
                            @endforeach
                        </select>
